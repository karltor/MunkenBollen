...
function renderBracketMatch(match, isFinal, twoLeg) {
    ...
    if (twoLeg) {
        html += `<div style="font-size:9px; color:#0d6e7a; font-weight:600; text-align:center; padding:2px 0;">MATCH 1</div>`;
    }
    html += dateStr;
    ...
    if (twoLeg) {
        ...
        html += `<div style="font-size:9px; color:#b38600; font-weight:600; text-align:center; padding:2px 0;">MATCH 2 (retur)</div>`;
        if (hasL2) {
